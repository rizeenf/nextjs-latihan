...
const AboutPage = async () => {
  ...
  return (
    <section className="max-w-xl text-justify">
      ...
      <div>
        <h2 className="text-xl mt-5 text-center font-bold">Our Mission</h2>
        <p className="text-gray-600">
      ...
      <div>
        <h2 className="text-xl mt-5 text-center font-bold">
          What Sets Us Apart
        </h2>
        <p className="text-gray-600 mt-2">
          &larr; Passion for Perfection: We are not just developers; we are
          artists crafting digital masterpieces. Every project is an opportunity
          to create something extraordinary.
        </p>
        <p className="text-gray-600 mt-2">
          &larr; Innovation as Standard: Embracing the latest technologies and
          design trends, we ensure your digital presence is always at the
          forefront of innovation.
        </p>
        <p className="text-gray-600 mt-2">
          &larr; Client-Centric Approach: Your success is our success. We
          collaborate closely with our clients, understanding their goals and
